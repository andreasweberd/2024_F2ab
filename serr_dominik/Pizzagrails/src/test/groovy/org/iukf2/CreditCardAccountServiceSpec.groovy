...
class CreditCardAccountServiceSpec extends Specification {
    ...
    CreditCardAccountService kreditkartenkontoService
    ...
    void "test list"() {
        ...
        when:
        List<CreditCardAccount> kreditkartenkontoList = kreditkartenkontoService.list(max: 2, offset: 2)
    ...
    void "test save"() {
        ...
        CreditCardAccount kreditkartenkonto = new CreditCardAccount()
